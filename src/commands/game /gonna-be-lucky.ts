...
import generateEvent from '../../../utils/game/gonna-be-lucky/generate-event'
import replyWithEvent from '../../../utils/game/gonna-be-lucky/reply-with-event'
import saveEventToDatabase from '../../../utils/game/gonna-be-lucky/save-event-to-database'
...
export async function execute(interaction: ChatInputCommandInteraction) {
  const timeOutEnd = gameTimeOut[interaction.user.id]
