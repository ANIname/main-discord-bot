...
const promt = (mention: string) =>
  ...
  '\n Суть игры проста. Ты генерируешь случайное событие (забавное, или смешное) и даёшь или отнимаешь очки.' +
  ...
  '\n Я хочу чтобы ты как добавлял очки, так и не забывал их отнимать.' + 
